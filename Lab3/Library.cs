...
namespace Library
{
    ...
    public class EtlXmlJsonOption //Основной класс
    {
    ...
    public class ParsOptions //Класс с парсерами
    {
        private string path;
    ...
    interface IParser //Интерфейс для парсеров
    {
        public T GetOptions<T>();
    }

    class jsonParser : IParser //json парсер
    {
        private Type classs;
        private string path;
    ...
    class XmlParser : IParser //xml парсер
    {
        private string path;
        private Type ttype;
